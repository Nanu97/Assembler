...
;------------------------------------------------------------------------------------
	...
	;EL OFFSET DE UN ARRAY EN SS:[BP+6] terminado en 003 (EOT)
...
;------------------------------------------------------
;		12) BUSCAR CARACTER, CONTAR Y MOSTRAR
;------------------------------------------------------

	cuentaIndividual proc
	...
	mov bx, SS:[BP+8] ; texto
	mov si, SS:[BP+6] ; offset caracter
	mov di, SS:[BP+4] ; contador
